...
def remove_nils_and_false_from_array(array)
  ...
  #array.select { |word| word.respond_to? :length }
end
...
def number_of_elements_that_are_palindromes(array)
  array.select{|word| palindrome_check word}.count
end

# return the shortest word in an array
def shortest_word_in_array(array)
  new = array.sort_by {|word| word.length}
  new[0]
end

# return the longest word in an array
def longest_word_in_array(array)
  array.group_by(&:size).max.last.pop
end
...
def average_of_array(array)
  (array.inject(:+).to_f/array.count).ceil
end
...
def get_elements_until_greater_than_five(array)
  array.chunk{|num| num < 6 }.first.last
end
...
def titleize_a_string(string)
  string.capitalize.split.map { |word| word.match(/the|and/) ? word : word.capitalize }.join(' ')
end
